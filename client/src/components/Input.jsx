    ...
    return (
        <div className='flex text-xl items-center gap-3 border-t-2 p-2 dark:bg-gray-900'>
            <input disabled={!chatActive} type="file" id="file" onChange={handleImageSelect}
                className="hidden" />
            <label htmlFor='file' className=''><FaPlus className={`bg-dcBlue text-[#fafafa] p-1 rounded-full w-6 h-6 ${imgSelected && "bg-slate-600"} transition-all hover:scale-125`} /></label>
